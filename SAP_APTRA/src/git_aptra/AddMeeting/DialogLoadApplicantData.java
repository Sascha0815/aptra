...
import git_aptra.InfoApplicant.DialogInfoApplicantApplication;
import git_aptra.InfoApplicant.DialogInfoApplicantContact;
import git_aptra.InfoApplicant.DialogInfoApplicantDetails;
import git_aptra.InfoApplicant.DialogInfoApplicantGeneral;
import git_aptra.InfoApplicant.DialogInfoApplicantHistory;
...
public class DialogLoadApplicantData {
	...
	public static void loadApplicantData(){
		...
		dialogLoadApplicantData.add(labelDivision,"cell 0 12,alignx left");
		dialogLoadApplicantData.add(fieldDivision,"cell 0 13 2 1,growx");
