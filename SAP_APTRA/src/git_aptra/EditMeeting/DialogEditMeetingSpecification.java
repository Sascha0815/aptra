...
public class DialogEditMeetingSpecification {
	...
	public static void editDetailsMeeting() {
		...
		fieldLocation.setText(EditMeeting.getDataSetLocation());
		fieldType.setText(EditMeeting.getDataSetTypeMeeting());
		dateChooserDate.setDate(EditMeeting.getDataSetDate());
		timeChooser.setTime(EditMeeting.getDataSetTime());
		...
		DialogEditMeeting.tabEdit.addTab("Termin", panelDialogMeetingSpecification);
		
		buttonBack.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				DialogEditMeeting.tabEdit.setSelectedIndex(0);
			}
		});
