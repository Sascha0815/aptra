...
public class DialogEditMeetingGeneral {
private static JPanel panelDialogMeetingMain = new JPanel();
	...
	public static void editMeetingGeneral(){
		...
		DialogEditMeeting.tabEdit.addTab("Allgemein", panelDialogMeetingMain);
		...
		buttonContinue.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				DialogEditMeeting.tabEdit.setSelectedIndex(1);
			}
		});
