...
public class DialogLoadEditApplicantData {
	...
	public static JTable tableDialogLoadEditApplicantData = new JTable(modelDialogLoadApplicantData);
	...
	public static void loadApplicantData(){
		...
		tableDialogLoadEditApplicantData.getTableHeader().setReorderingAllowed(false);
		tableDialogLoadEditApplicantData.setAutoCreateRowSorter(true);
		tableDialogLoadEditApplicantData = new JTable(modelDialogLoadApplicantData);
		JScrollPane scrollPaneLoadApplicantData = new JScrollPane(tableDialogLoadEditApplicantData);
		...
		tableDialogLoadEditApplicantData.setRowHeight(20);
		tableDialogLoadEditApplicantData.setAutoCreateRowSorter(true);
		resultsLoadApplicantDataAll = LoadEditApplicantData.insertLoadApplicantDataIntoTable();
		DialogLoadEditApplicantData.modelDialogLoadApplicantData.setDataVector(resultsLoadApplicantDataAll,DialogLoadEditApplicantData.COLUMN_IDENTIFIERS_VACANCYMANAGEMENT_MEETING);
		DialogLoadEditApplicantData.modelDialogLoadApplicantData.fireTableDataChanged();
		...
		buttonSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				getApplicantData();
				try {
					resultsLoadApplicantData = LoadEditApplicantData.loadApplicanData();
		...
		buttonSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				DialogEditMeetingGeneral.labelApplicantIDContent.setText((String) tableDialogLoadEditApplicantData.getValueAt(tableDialogLoadEditApplicantData.getSelectedRow(), 0));
				DialogEditMeetingGeneral.labelNameContent.setText((String) tableDialogLoadEditApplicantData.getValueAt(tableDialogLoadEditApplicantData.getSelectedRow(), 1));
				DialogEditMeetingGeneral.labelFirstNameContent.setText((String) tableDialogLoadEditApplicantData.getValueAt(tableDialogLoadEditApplicantData.getSelectedRow(), 2));
				DialogEditMeetingGeneral.labelVacancyIDContent.setText((String) tableDialogLoadEditApplicantData.getValueAt(tableDialogLoadEditApplicantData.getSelectedRow(), 3));
				DialogEditMeetingGeneral.labelPositionContent.setText((String) tableDialogLoadEditApplicantData.getValueAt(tableDialogLoadEditApplicantData.getSelectedRow(), 4));
