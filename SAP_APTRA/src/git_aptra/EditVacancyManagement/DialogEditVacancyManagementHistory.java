...
public class DialogEditVacancyManagementHistory {
	...
	public static void editVacancyManagementHistory(){
		...
		// SWING:Table Bewerber-Management History
				...
				tableVacancyManagementHistory.getTableHeader().setReorderingAllowed(false);
				tableVacancyManagementHistory.setAutoCreateRowSorter(true);
				tableVacancyManagementHistory = new JTable(modelVacancyManagementHistory);
				JScrollPane scrollPaneVacancyManagementHistory = new JScrollPane(
						tableVacancyManagementHistory);
				panelDialogVacancyManagementHistory.add(scrollPaneVacancyManagementHistory);
		...
		DialogEditVacancyManagement.tabEditVacancyManagment.addTab("Dokumentation",
