...
public class Waitinglist {
	...
	private static Paragraph mainPart = new Paragraph("Wir müssen Ihnen leider mitteilen, dass Sie aufgrund der hohen Bewerberanzahl auf die Warteliste gesetzt wurden. Wir setzen uns schnellstmöglich mit Ihnen wieder in Verbindung wenn für sie eine neue Möglichkeit offen steht.");
	private static Paragraph noteOfThanks = new Paragraph("Wir danken Ihnen für Ihre Mühe, die Sie sich mit der Bewerbung gemacht haben.");
